...
(function(window, document, $, undefined){
	...
	app.init = function() {
		...
		// Load spinner
		app.$.body.append('<div class="ajax-spinner"><i class="fa fa-spinner fa-spin fa-3x"></i></div>');
		...
		app.$.body.hammer().on( 'doubletap', '.site-title-wrap', function(e) {
		...
		// Add back button
		app.$.subMenu.next('ul').prepend('<a href="#" class="menu-back"><i class="fa fa-angle-left fa-lg"></i> Back</a>' );
		...
		*/
		...
		app.$.body
			...
			// })
			.on('click', '.ajaxify, .ajaxify a, .blog .post a', function(event) {
				var $self = $(this);
		...
		document.addEventListener("offline", function () {
			alert('You appear to be offline, please try again when you are online.');
		}, false);
	...
	app.loadAjaxContent = function( href, $selector, event) {
		...
		//console.log(responseText);
			...
			titles.navtitle.text( newtitles.navtitle.text() );
