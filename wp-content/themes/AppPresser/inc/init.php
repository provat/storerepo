...
class AppPresser_Theme_Functions extends AppPresser_Theme_Setup {
	...
	public function scripts_styles() {
		// Main stylesheet
		wp_enqueue_style( 'appp-style', get_stylesheet_uri(), null, parent::VERSION );
		...
		if ( $use_concatenated ) {
			...
			// multi touch events
			wp_enqueue_script( 'hammer', APPP_THEME_URL ."js/jquery.hammer-full.js", array( 'jquery' ) );
			wp_enqueue_script( 'fakehammer', APPP_THEME_URL ."js/hammer.fakemultitouch.js", array( 'jquery' ) );
		}

		$dependencies = $use_concatenated ? 'appp_plugins' : 'snap';

		wp_enqueue_script( 'appp-js', APPP_THEME_URL ."js/custom$min.js", array( $dependencies ), parent::VERSION, true );
