	...
	public function colors() {
		...
		$this->colors = array(
			...
			'button_bg' => array(
				...
				'sprintf' => '.btn-primary, .woocommerce .button, input[type="submit"], #buddypress input[type=submit], .woocommerce .quantity .plus, .woocommerce .quantity .minus, .woocommerce .quantity input.qty { background-color: **color** !important; }',
			),
			/* 'button_hover' => array(
				'default' => '#378f46',
