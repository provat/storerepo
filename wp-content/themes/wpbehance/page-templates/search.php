...
$cat_project_objs = $wpdb->get_results("select * from wp_posts where ".$where_clause." order by ID DESC");
...
if($country_fld!='' || $state_fld!='' || $city_fld!='')
{
	...
	$project_query = "select * from wp_posts where ".$where_main." order by ID DESC";
