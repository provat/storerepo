...
get_header(); 
       ...
       $draft_project=array('lang' => ICL_LANGUAGE_CODE, 'post_type' => 'projects', 'author' => $user_id);
     ...
     $dyn_no_left="yes";
        ...
        <div class="<?php echo ($dyn_no_left=="yes")?"no_left_panle_mid_area":"mid_rightarea"?>">
        	<div class="<?php echo ($dyn_no_left=="yes")?"no_left_box_mid":"box_mid"?>">
                ...
                $publish_draft_project=array('lang' => ICL_LANGUAGE_CODE, 'post_type' => 'projects', 'author' => $user_id ,'nopaging'   => true,'post_status' => array('publish','draft', 'auto-draft'));
                
               // $n=array('lang' => ICL_LANGUAGE_CODE,'post_type' => 'projects', 'post_status'=>'publish');
                $publish_draft_project_query = new WP_Query( $publish_draft_project );

                
                $publish_draft_project_objs =  $publish_draft_project_query->posts;
                //echo "<pre>";
                if(count($publish_draft_project_objs)){
                    ?>
                    ...
                    <div  id="project_cover<?php echo $project->ID; ?>" class="project_cover_hover_action">
                      ...
                      <?php if ($project->post_status=='publish'){
                       ...
                       <li>
                        ...
                        <?}else{?>
                       <li>
                          <a href="#" onclick='jQuery.publishProject(event,"<?php echo $project->ID; ?>","<?php echo get_the_title($project->ID); ?>")'>Publish Project</a>
                      </li>
                        <?} ?>
