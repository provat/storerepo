    ...
    <?php else : ?>
        <form action="javascript://" id="login_form" class="ajax-login-default-form-container <?php print get_option('ajax_login_register_default_style'); ?>">
            ...
            <div class="form-wrapper">
                ...
                <div class="noon"><label><?php _e('Email','ajax_login_register'); ?></label><input type="text" name="user_login" size="30"  /></div>
                <div class="noon"><label><?php _e('Password','ajax_login_register'); ?></label><input type="password" name="password" id="password" size="30"  /></div>
                <div class="noon"><label>Solve This&nbsp;&nbsp;<span id = "captcha"><?php echo rand(0,9); ?></span>&nbsp;(+)&nbsp;<span id = "captcha2"><?php echo rand(0,9); ?></span></label><input type="text" name="captcha" id="captcha-value" size="30"  /><label for="captcha_answer" generated="true" class="error customcaptchamsg" style = "display:none;top: 25px;font-size: 10px;right: 3;">Sorry, the solution is incorrect.</label></div>                
