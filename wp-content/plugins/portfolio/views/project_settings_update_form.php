...
<div class="projects_settings_frms">
  ...
  <br/><span></span>&nbsp;&nbsp;<span><input type="checkbox" name="country_all" id="country_all" value="Y">Check if geo tagged for all country</span><br/><br/>
        <span>Street Address</span>
        <input type="text" name="project_street" id="project_street"  value=""/>      
  <br/><span></span>&nbsp;&nbsp;<span><input type="checkbox" name="street_all" id="street_all" value="Y">Check if geo tagged for all street</span><br/><br/>
  
        <span>State</span>
        <input type="text" name="project_state" id="project_state"  value=""/>      
	<br/><span></span>&nbsp;&nbsp;<span><input type="checkbox" name="state_all" id="state_all" value="Y">Check if geo tagged for all states</span><br/><br/>
        <span>City</span>
        <input type="text" name="project_city" id="project_city"  value=""/>
	<br/><span></span>&nbsp;&nbsp;<span><input type="checkbox" name="city_all" id="city_all" value="Y">Check if geo tagged for all cities</span><br/><br/>  
	 <span>ZipCode</span>
        <input type="text" name="project_zip" id="project_zip"  value=""/>
  <br/><span></span>&nbsp;&nbsp;<span><input type="checkbox" name="zip_all" id="zip_all" value="Y">Check if geo tagged for all zip</span><br/>  
