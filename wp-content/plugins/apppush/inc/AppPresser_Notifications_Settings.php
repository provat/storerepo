...
class AppPresser_Notifications_Settings {
	...
	public function notifications_settings( $appp ) {
		...
		$appp->add_setting( AppPresser_Notifications::APPP_KEY, __( 'AppNotifications License Key', 'apppresser-push' ), array( 'type' => 'license_key', 'tab' => 'appp-notifications', 'helptext' => __( 'Adding a license key enables automatic updates.', 'appp-notifications' ) ) );
