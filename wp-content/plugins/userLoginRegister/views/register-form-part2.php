...
<?php if ( get_option('users_can_register') ) : ?>
    <div class="ajax-login-register-register-container">
        ...
        <?php else : ?>
            <form action="javascript://" id="register_form_part2" name="registerform" class="ajax-login-default-form-container <?php print get_option('ajax_login_register_default_style'); ?>">
			...
			<input type="hidden" name="hdnRegisterId" id="hdnRegisterId" value="" />
			...
			<?php } ?>
                    ...
                    <div class="button-container" id="register_button_pane">
                        <input id="register_button_id" type="submit" value="<?php _e('Register','ajax_login_register'); ?>"  name="register" class="green" />
