    ...
    <div class="ajax-login-register-register-container">
        ...
        <?php else : ?>
		    ...
		    <div class="error_mess"></div>
                    ...
                    <div class="noon"><label><?php _e('Email', 'ajax_login_register'); ?></label><input type="text" name="login" id="user_login" class=""/></div>
                    ...
                    <div class="button-container" id="register_button_pane">
                        <input id="register_button_id" type="submit" value="<?php _e('Next','ajax_login_register'); ?>" accesskey="p" name="register" class="green" />
