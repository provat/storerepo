...
Class Login Extends AjaxLogin {
    ...
    public function login_submit( $user_login=null, $password=null, $is_ajax=true ) {
        ...
        if(is_wp_error( $user )){
            ...
            $msg="<strong>ERROR</strong>: The Email or password you entered is incorrect.";
        }
        //print is_wp_error( $user ) ?  $user->get_error_message() : $user->data->user_login;
    ...
    public function facebook_login(){
		...
		//$msg = array($user_id, $username, $email, $password);
		...
		$msg = $user_id;
            if ( ! is_wp_error( $user_id ) ) {
                ...
                update_user_meta($user_id, 'nickname', $showName);

                wp_update_user( array( 'ID' => $user_id, 'role' => 'subscriber','display_name' => $showName ) );
