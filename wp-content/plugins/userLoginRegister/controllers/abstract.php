...
abstract Class AjaxLogin {
    ...
    public $status = array(
        array(
            ...
            'msg' => 'Pass',
            'field' => '',
            'description' => '<div class="success-container">Success! You have successfully register...</div>'
            ),
        array(
            'status' => 1,
            'cssClass' => 'error',
	...
	array(
            ...
            'msg' => 'Fail',
            'cssClass' => 'error',
            'description' => '<div class="error-container">Profile name already exists</div>'
            )
        );
    ...
    public function enqueue_scripts( $scripts=null ){
       ...
       if ( !is_user_logged_in() ) {     
        ...
        wp_enqueue_script( 'ajax-validate-script', plugin_dir_url( dirname( __FILE__ ) ) . 'assets/jquery.validate.min.js');
