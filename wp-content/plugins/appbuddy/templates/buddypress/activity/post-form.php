<div id="activity-form-modal">	
		<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form-in-modal" name="whats-new-form" role="complementary">
			...
			<div id="whats-new-content">
				...
				<div id="whats-new-options">
					...
					<button type="button" name="aw-whats-new-submit" id="aw-whats-new-submit" class="btn btn-primary btn-camera"><i class="fa fa-pencil"></i> <?php esc_attr_e( ' Post Update', 'buddypress' ); ?></button>
		...
		<div id="activity_add_media" class="">
			<?php if(function_exists('appp_camera') ) : ?>
				<button type="button" id="attach-photo" class="btn btn-primary btn-camera"><i class="fa fa-camera"></i> <?php _e('Attach Photo', 'apppresser-camera'); ?></button>
				<div id="image-status"></div>
			<?php endif; ?>
		</div>
</div>

	<div id="attach-image-sheet" class="action-sheet-backdrop hide">
		<div class="action-sheet-wrapper action-sheet-up">
			<div class="action-sheet">
				<div class="action-sheet-title">Choose an Image</div>
				<div class="action-sheet-group">
					<?php if( function_exists('appp_camera') ) : ?>
					<?php appp_camera( array('action' => 'attach', 'description' => '') ); ?>
					<?php endif; ?>
				</div>
				<div class="action-sheet-group">
