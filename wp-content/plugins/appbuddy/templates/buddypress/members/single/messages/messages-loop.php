		...
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			...
			<li id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread<?php else: ?> read<?php endif; ?>">
				...
				<div class="thread-avatar">
					<a href="<?php bp_message_thread_view_link(); ?>" title="<?php esc_attr_e( "View Message", "buddypress" ); ?>"><?php bp_message_thread_avatar(); ?></a>
					<div class="thread-from"<?php bp_message_thread_from(); ?></div>
				</div>

				<div class="thread-info">
					<p class="message-title"><a href="<?php bp_message_thread_view_link(); ?>" title="<?php esc_attr_e( "View Message", "buddypress" ); ?>"><?php bp_message_thread_subject(); ?></a></p>
				</div>
