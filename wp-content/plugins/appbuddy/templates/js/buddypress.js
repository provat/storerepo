(function(window, document, $, undefined){
	var cookiebuster = function(){
		...
		$.cookie('bp-activity-scope', null, {
			path: '/'
		});
		$.cookie('bp-activity-filter', null, {
			path: '/'
		});
		$.cookie('bp-activity-oldestpage', null, {
			path: '/'
		});

		var objects = [ 'members', 'groups', 'blogs', 'forums' ];
		jq(objects).each( function(i) {
			$.cookie('bp-' + objects[i] + '-scope', null, {
				path: '/'
			} );
			$.cookie('bp-' + objects[i] + '-filter', null, {
				path: '/'
			} );
			$.cookie('bp-' + objects[i] + '-extras', null, {
				path: '/'
			} );
		});
	...
	$(document).on( 'ready', cookiebuster ).on( 'load_ajax_content_done', cookiebuster );
...
jq(document).ready( function() {
	...
	jq('body').on( 'click', 'div.activity', function(event) {
		...
		if ( target.parent().hasClass('load-more') ) {
			...
			jq("#buddypress li.load-more a").html('<i class="fa fa-spinner fa-spin fa-lg"></i>');
